...
\begin{tikzpicture}
    ...
    % MKS15
    \filldraw[orange] (12.35,1.0) -- (12.35+0.5,2) -- (12.35-0.5,2) -- cycle;

    \draw[-latex,orange,ultra thick] (12.35,1.75) -- (11.3,1.75) -- (11.3,0.4);

    \filldraw[orange!50] (11.6,1.75) circle (0.25);
    \node at (11.6,1.75) {\belemsiz $\Delta \Phi$};

    \draw[-latex,orange,ultra thick] (12.35,1.75) -- (14.5+0.15/2,1.75) -- (14.5+0.15/2,0.4);

    \filldraw[orange!50] (14,1.75) circle (0.25);
    \node at (14,1.75) {\belemsiz $\Delta \Phi$};

    \filldraw[orange!50] (13.25,1.75) circle (0.25);
    \node at (13.25,1.75) {\belemsiz $\Delta P$};

    \node[align=center,anchor=north] at (12.35,2) {\belemsiz MKS\\ \belemsiz 15};

    % MKS10
    \filldraw[orange] (10.7,1.0) -- (10.7+0.5,2) -- (10.7-0.5,2) -- cycle;
    \draw[orange, ultra thick, -latex] (10.5,1.75) -- (9.3,1.75) -- (9.3,0.4);
    \draw[orange, ultra thick, -latex] (10.5,1.75) -- (7.3,1.75) -- (7.3,0.4);

    \node[align=center,anchor=north] at (10.7,2) {\belemsiz MKS\\ \belemsiz 10};

    % MKS31
    \filldraw[orange] (6.4,1.0) -- (6.4+0.5,2) -- (6.4-0.5,2) -- cycle;
    \draw[orange, ultra thick, -latex] (6.4,1.75) -- (5.125,1.75) -- (5.125,0.6);
%    \draw[orange, ultra thick, -latex] (10.5,1.75) -- (7.3,1.75) -- (7.3,0.4);

    \node[align=center,anchor=north] at (6.4,2) {\belemsiz MKS\\ \belemsiz 31};
