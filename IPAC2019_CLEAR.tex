...
As seen from the layout, the CLEAR machine is well equipped with diagnostics~\cite{HelenPHELMA} for measuring the beam parameters such as bunch charge and train length, bunch length, energy- and energy-spread, and Twiss parameters, as well as combinations thereof.
...
Here, the BPMs themselves as well as the electronics are currently being tested, with initial tests indicating that a more robust in-tunnel electronics is needed~\cite{NadenauThesis}.
...
This removes the need for using multiple lenses to control the beam size, and may have important applications for future linear colliders~\cite{CarlApochromatic,SteinkeCoupling} and particle sources~\cite{Braun1,Braun2}.

The CLEAR plasma lens experiment~\cite{CLEAR-PLE,Erik::CLEARrev} has until now mainly focused on showing emittance preservation and uniformity of the focusing gradient in different gasses.
...
\bibitem{Erik::CLEARrev} E. Adli, ``Plasma lens research at CLEAR,'' presented at the CLAER review 2019. \url{https://indico.cern.ch/event/781404/contributions/3304103/}
...
\bibitem{Braun1} H. Braun, E. Boggasch, D. H. H. Hoffmann, and A. Tauschwitz, “Application of Plasma Lenses in Positron Sources,” p. 3.
...
\bibitem{Xboxen} N. Catalán Lasheras et al., “Experience Operating an X-band High-Power Test Stand at CERN,” in Proceedings of the 5th Int. Particle Accelerator Conf., 2014, vol. IPAC2014, pp. 3 pages, 0.868 MB.
