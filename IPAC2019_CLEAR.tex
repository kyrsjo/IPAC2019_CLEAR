...
Additionally it is also possible to collect and accelerate the dark current produced by the gun in order to make a long train with sub-pC bunch charge; this is sometimes used for irradiation.
...
This has helped RF system reliability, and also 

Consolidation of klystron hardware

Laser/dark current beam
...
Alignment -- last quads, structure, verification of rest of quads, aperture.
